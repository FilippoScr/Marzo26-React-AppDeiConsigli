...
<strong>1. reactapp1-v1 &emsp;&emsp;&emsp;</strong>
Versione minimale, sviluppata utilizzando le props.
È il risultato del primo esercizio.
<br>
<strong>2. reactapp2-v2Complete &emsp;&emsp;&emsp;</strong>
...
Per comprendere meglio le differenze richieste tra i due esercizi, ho adottato la tecnica “copia e rivoluziona”, inizialmente ho duplicato la prima versione e successivamente ho applicato le modifiche necessarie per completare tutti i punti del secondo esercizio.
<br>
<h4>🛠️ Principali modifiche e implementazioni:</h4>
• Utilizzo della Context API al posto delle props (con conseguente riorganizzazione del codice).
